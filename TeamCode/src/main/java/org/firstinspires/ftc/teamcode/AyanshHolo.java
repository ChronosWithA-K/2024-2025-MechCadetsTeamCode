...
@TeleOp(name="Basic: Custom Ayansh Holonomic", group="Linear OpMode")
public class AyanshHolo extends LinearOpMode {
...
//            }
            ...
            if (!prevIntake) {
                if (intake && bucketServoPosition == 0.0) {
                    bucketServoPosition = 1.0;
                } else if (intake && bucketServoPosition == 1.0) {
